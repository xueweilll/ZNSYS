...
public class SmsLogDAO extends DAOImp
{
	...
	public SmsLog find(int id){
		Query query = this.getCurrentSession().createQuery("from SmsLog as c where c.id");
	...
	@SuppressWarnings("unchecked")
	public List<SmsLog> Query(String smstype,String content,String tel,String begintime,String endtime)
	{
		StringBuffer hql = new StringBuffer();
		...
		if ((begintime != null) && (!begintime.equals("")))
			hql.append("and c.sms.sendreqtime>='" + begintime + " 00:00:00' ");
		if ((endtime != null) && (!endtime.equals("")))
			hql.append("and c.sms.sendreqtime<='" + endtime + " 23:59:59' ");
