...
public class RoleDAO extends DAOImp
{
	...
	{
		Role r=(Role)this.getCurrentSession().load(Role.class, id);
		return r;
	}
	...
	{
		Query query=this.getCurrentSession().createQuery("select distinct r from Role as r left join r.functions as f where r.id=:id");
