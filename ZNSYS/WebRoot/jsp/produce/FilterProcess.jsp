		...
		$(function(){
			...
			$("#area").combobox({
				    ...
				    onChange: function (newValue, oldValue) {
         			 ...
         			 onSelect: function(rec){ 
         		         			 var url='JsonProcessByArea?area='+rec.area;  
         							 $('#grid').datagrid({url:url});
         							 $('#grid').datagrid("reload");
         					         var url='searchWellByArea?searchWell='+rec.area; 
			...
			$("#well").combobox({
			    ...
			    onChange: function (newValue, oldValue) {
     			 ...
     			 onSelect: function(rec){   
     							 var url='JsonProcessByWell?well='+rec.well;  
     							 $('#grid').datagrid({url:url});
     							 $('#grid').datagrid("reload");
     							 var url='searchPhByWell?searchPh='+rec.well; 
			...
			$("#select").combobox({
				 url:'searchProgram?searchProgram= ',   
				    ...
				    onChange: function (newValue, oldValue) {
					                if (newValue != null) {
					                    var thisKey =$.trim($("#select").combobox('getText')); //搜索词
								...
								onDblClickRow: function(rowindex,rowdata){
         			 			...
         			 			onSelect: function(rec){ 
          							 var url='JsonProcessByJcxm?jcxm='+rec.jcxm;  
          							 $('#grid').datagrid({url:url});
          							 $('#grid').datagrid("reload");  
          					    }   
				});
