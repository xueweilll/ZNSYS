...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
	...
	<body>
		...
		<div class="content">
			...
			<div class="center">
				<div class="img">
					<img src="images/main/009.png"onclick="window.open('http://10.72.21.1')">
					<img src="images/main/007.png" onclick="window.open('http://10.72.21.2:600/LABSoftManage.asp?GN=1')">
					...
					<img src="images/main/002.png" onclick="window.location.href='index.jsp?menu=002001'">
					<img src="images/main/006.png" onclick="window.location.href='index.jsp?menu=003002'">
					<img src="images/main/010.png" onclick="window.location.href='index.jsp?menu=004001'">
					<img src="images/main/004.png" onclick="window.location.href='index.jsp?menu=008'"><br>
					<img src="images/main/005.png" onclick="window.location.href='index.jsp?menu=005003'">
					<img src="images/main/003.png" onclick="window.location.href='index.jsp?menu=006002'">
