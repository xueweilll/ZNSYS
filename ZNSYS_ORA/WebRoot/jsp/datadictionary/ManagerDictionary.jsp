		...
		$(function(){
			...
			({
				...
				columns:[[				    						
				    ...
				    {title:'列名称',field:'PYDM',width:100,align:'center'},
				    {title:'序号',field:'XH',width:80,align:'center'},
				    {title:'数据项名称',field:'SJXMC',width:80,align:'center'},
				    {title:'数据类型',field:'LX',width:80,align:'center'},
				    {title:'数据长度',field:'KD',width:100,align:'center'},
				    {title:'精确位数',field:'XSWS',width:80,align:'center'},
				    {title:'计量单位',field:'JLDW',width:80,align:'center'},
				    {title:'字段名',field:'PK',width:80,align:'center'},
				    {title:'附键',field:'AK',width:100,align:'center'},
				    {title:'关联表',field:'CZB',width:80,align:'center'},
				    {title:'是否外键',field:'FKZ',width:80,align:'center'},
				    {title:'值约束',field:'ZYS',width:80,align:'center'},
				    {title:'提示信息',field:'TXGD',width:100,align:'center'},
