...
<head>
	...
	var mynode;
	var flag;
	var belongins=[{id:'1',name:'下属单位'},{id:'2',name:'处里部门'}];
	$(function(){
		$('#belongin').combobox({
			editable:false,
			data:belongins,	
	...
	function deleteDepartment()
	{
		if (depid==null)
		{
			...
			showConfirm('您确认要删除该部门吗?',function(){
				$('#popmenu1').menu('hide');
				$.ajax({
...
<body>
	<div class="easyui-panel" fit="true" title="部门管理">
	<ul id="tree1" ></ul>
	</div>
	...
	<div id="dep" style="width:360px;height:220px;">
		<div id="popup_content" style="padding:10px 10px 10px 40px;">
			<form id="form1" method="post">
				...
				<table>	
					<tr>
					<td><div align="right"><sup>*</sup>部门名称：</div></td>
					<td><input type="text" id="name" name="name" style="width:180px;"/></td>					
					</tr>	
					<tr>
					<td><div align="right"><sup>*</sup>部门性质：</div></td>
