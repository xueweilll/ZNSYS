	...
	<head>
		...
		<script>
	    	...
	    	function Search(){
	    		...
	    		var sql="select jcxm,case when jcr is null then '空' else jcr end as jcr,case when sum(ypsl) is null then 0 else sum(ypsl) end as ypsl from syzx_ajhf03 where 1=1";
	    		if(start !=""){
