...
public class BaseAction extends ActionSupport {
	...
	public void jsonpArray(List list)
	{
		String result = JSONOperator.jsonArray(list);
		printJsonp(result);
	}
	...
	public void jsonpDataGrid(List list)
	{
		printJsonp(JSONOperator.jsonDataGrid(list, page, rows));
	}
	...
	public void printJsonp(String jsonstr){
		...
		try {
			...
			out.write(jsonpCallBack+"("+jsonstr+")");
			out.close();
		} catch (IOException e) {
		}
	}
