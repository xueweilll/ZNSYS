...
public class Push extends Pojo
{
	/**主键自增长*/
	@Id
	@SequenceGenerator(name = "SEQ_T_SA_PUSH", sequenceName = "SEQ_T_SA_PUSH", allocationSize = 1)
    @GeneratedValue(generator = "SEQ_T_SA_PUSH", strategy = GenerationType.SEQUENCE)
