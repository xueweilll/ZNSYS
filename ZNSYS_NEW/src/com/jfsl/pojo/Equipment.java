...
{
	@Id
	@SequenceGenerator(name = "SEQ_E_EQUIPMENT", sequenceName = "SEQ_E_EQUIPMENT", allocationSize = 1)
    @GeneratedValue(generator = "SEQ_E_EQUIPMENT", strategy = GenerationType.SEQUENCE)
